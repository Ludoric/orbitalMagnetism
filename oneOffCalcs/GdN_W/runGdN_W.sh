...
# mpirun -np 25 "$BINLOC/pw2wannier90.x" -in GdN_W_up.pw2wan.in > GdN_W_up.pw2wan.out
# mpirun -np 25 "$BINLOC/pw2wannier90.x" -in GdN_W_dw.pw2wan.in > GdN_W_dw.pw2wan.out
