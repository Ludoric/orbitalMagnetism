...
# mpirun -np 64 "$BINLOC/pw.x" -npool 4 -in SmN_vc-relax.pw.in | tee SmN_vc-relax_2.pw.out
...
# $BINLOC/bands.x < SmN_M_S1.bands.in | tee  SmN_M_S1.bands.out
# $BINLOC/bands.x < SmN_M_S2.bands.in | tee  SmN_M_S2.bands.out
