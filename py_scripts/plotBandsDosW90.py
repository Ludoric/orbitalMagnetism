...
def plotBandsW90(fup, fdw, fermi, cell, *, ylim=(None, None), outName=None,
        ax=None, onlyBands=False):
    ...
    ax.plot(bnd_up[0], bnd_up[1], '-r', zorder=1)
    ax.plot(bnd_dw[0], bnd_dw[1], ':b', zorder=2)
    ...
    ax.tick_params(axis='y', color='k', width=1, direction='out')
    ax.axhline(0, ls='--', c='k', lw=1, zorder=0)  # line at zero
...
def plotBandsDosW90(fup, fdw, fermi, cell, *, dos_clip=None,
    ...
    _, ax = plotBandsW90(fup, fdw, fermi, cell, ylim=ylim, ax=ax1)
